---
name: "gode-mode"
description: "Alias da skill aiox-god-mode para ativacao via /gode-mode (compatibilidade de digitacao)."
allowed-tools: "Read Write Edit Glob Grep Bash(git:*) Bash(npm:*) Bash(node:*) Bash(mkdir:*) Bash(ls:*) Bash(cp:*)"
argument-hint: "[command] [args]"
---

# Gode Mode (Alias de aiox-god-mode) v3.0 — Supreme Creator Edition
