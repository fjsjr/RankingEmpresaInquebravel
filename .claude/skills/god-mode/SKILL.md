---
name: "god-mode"
description: "Alias da skill aiox-god-mode para ativacao via /god-mode. Mantem as mesmas capacidades de orquestracao AIOX."
allowed-tools: "Read Write Edit Glob Grep Bash(git:*) Bash(npm:*) Bash(node:*) Bash(mkdir:*) Bash(ls:*) Bash(cp:*)"
argument-hint: "[command] [args]"
---

# God Mode (Alias de aiox-god-mode) v3.0 — Supreme Creator Edition
