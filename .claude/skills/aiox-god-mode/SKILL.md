---
name: "aiox-god-mode"
description: "The Supreme AIOX Operator — creates, configures, and orchestrates everything in Synkra AIOX. Trigger explicitly with /aiox-god-mode (or /god-mode) across projects. Creates agents, tasks, workflows, squads, templates, checklists, rules, and data files. Operates all 11 agents, 207+ tasks, 15 workflows. Enforces Constitutional governance, story lifecycle, and delegation matrix. Activates when users mention AIOX, agents, stories, epics, workflows, sprints, quality gates, creating components, or any development orchestration task."
